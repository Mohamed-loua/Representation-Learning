...
LOG_FOLDER = '/home/mila/c/chris.emezue/representation-learning-assignment/assignment2/assignment/models'
model_path = os.path.join(os.path.join(LOG_FOLDER,f'{experimental_setting}'),f'model_{experimental_setting}.pt')
...
PERTURBED_TEXT = '/home/mila/c/chris.emezue/representation-learning-assignment/assignment2/assignment/perturbed_text'
save_perturbed_text_filename = os.path.join(PERTURBED_TEXT,f'{ptype}.txt')
#save_text(augmented_review,save_perturbed_text_filename)
augmented_review = load_text(save_perturbed_text_filename)
...
output = getPrediction(augmented_review)
...
exp_perturbed = os.path.join(SAVE_PERTURBED_RESULT,f'{experimental_setting}')
os.makedirs(exp_perturbed,exist_ok=True)
save_filename = os.path.join(exp_perturbed,f'{ptype}.txt')
save_text(str(output),save_filename)